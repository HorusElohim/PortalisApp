...
pub use limits::{
    ...
    DEVICE_ID_BYTES, DEVICE_KEY_BYTES, DISCRIMINATOR_CHARS, ENCRYPTION_KEY_BYTES, MAX_FRAME_BYTES,
    MAX_KEY_ENVELOPE_CIPHERTEXT_BYTES, MAX_KEY_ENVELOPES_PER_PAGE, MAX_OUTBOUND_QUEUE,
    MAX_PENDING_REQUESTS, MAX_USERNAME_CHARS, MESSAGE_ID_BYTES, MIN_USERNAME_CHARS, SHARE_ID_BYTES,
