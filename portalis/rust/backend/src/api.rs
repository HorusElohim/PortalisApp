...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -458073992;
...
fn wire__crate__bridge__peer_hints_create_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::bridge::peer_hints_create(api_peers))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__bridge__peer_hints_discover_local_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::bridge::peer_hints_discover_local())?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__bridge__peer_hints_from_magnet_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok =
                    Result::<_, ()>::Ok(crate::bridge::peer_hints_from_magnet(api_magnet))?;
                Ok(output_ok)
            })())
        },
    )
...
fn wire__crate__bridge__peer_hints_validate_address_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok =
                    Result::<_, ()>::Ok(crate::bridge::peer_hints_validate_address(api_address))?;
                Ok(output_ok)
            })())
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        16 => wire__crate__portalis_api__share_uri_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__portalis_api__start_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__portalis_api__stop_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__portalis_api__storage_breakdown_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__portalis_api__watch_detail_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__portalis_api__watch_history_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__portalis_api__watch_states_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
