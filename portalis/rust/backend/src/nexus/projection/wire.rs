...
impl Wire for Status {
    fn wire(&self) -> &'static str {
        match self {
            ...
            Self::Paused => "Paused",
            Self::Draft => "Draft",
            Self::ResolvingMetadata => "ResolvingMetadata",
            Self::WaitingForSender => "WaitingForSender",
            Self::MetadataReady => "MetadataReady",
            Self::DownloadRequested => "DownloadRequested",
            Self::RetryingMetadata => "RetryingMetadata",
    ...
    fn parse(word: &str) -> Option<Self> {
        Some(match word {
            ...
            "Paused" => Self::Paused,
            "Draft" => Self::Draft,
            "ResolvingMetadata" => Self::ResolvingMetadata,
            "WaitingForSender" => Self::WaitingForSender,
            "MetadataReady" => Self::MetadataReady,
            "DownloadRequested" => Self::DownloadRequested,
            "RetryingMetadata" => Self::RetryingMetadata,
...
mod tests {
    ...
    fn every_status_keeps_the_word_the_interface_matches_on() {
        let contract = [
            ...
            (Status::Draft, "Draft"),
            (Status::ResolvingMetadata, "ResolvingMetadata"),
