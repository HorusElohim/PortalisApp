...
// These functions are ignored because they are not marked as `pub`: `acquire_selection`, `add_info_hash_with_peers`, `advance_hashing`, `advance`, `bt_listen_port_cached`, `bt_listen_port`, `cancel`, `complete_final_piece`, `delete_torrent_files`, `download_dir`, `ensure_active`, `fail`, `forget_torrent`, `inspect_source_files`, `inspect_source`, `is_magnet`, `is_remote_source`, `is_torrent_path`, `make_source_names_unique`, `new`, `numbered_source_name`, `pause_torrent`, `publish`, `restart_torrent`, `restore_linked_sources`, `session_started`, `set_rate_limits`, `set_stage`, `snapshot`, `storage_breakdown`, `validate_source_files`, `verify_linked_sources`
