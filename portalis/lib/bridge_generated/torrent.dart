...
// These functions are ignored because they are not marked as `pub`: `add_info_hash_with_peers`, `advance_hashing`, `advance`, `bt_listen_port_cached`, `bt_listen_port`, `cancel`, `complete_final_piece`, `delete_torrent_files`, `ensure_active`, `fail`, `forget_torrent`, `inspect_source_files`, `make_source_names_unique`, `metadata_from_torrent_bytes`, `metadata_from_torrent_path`, `new`, `numbered_source_name`, `pause_torrent`, `publish`, `restart_torrent`, `restore_linked_sources`, `session_started`, `set_rate_limits`, `set_stage`, `snapshot`, `storage_breakdown`, `validate_source_files`, `verify_linked_sources`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `PublishProgressState`, `PublishProgress`, `RawStorageEntry`, `TorrentMetadataFile`, `TorrentMetadata`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_fields_are_eq`, `assert_fields_are_eq`, `assert_fields_are_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`
